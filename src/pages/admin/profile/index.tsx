...
export default function AdminProfilePage() {
        ...
        const updateEmail = (idx: number, value: string) => {
                setEmails((prev) => prev.map((email, i) => (i === idx ? value : email)));
        };
        ...
        const updatePhone = (idx: number, value: string) => {
                setPhones((prev) => prev.map((phone, i) => (i === idx ? value : phone)));
        };
        ...
        const handleSave = async () => {
                ...
                try {
                        ...
                        setToastMessage({
                                status: 'error',
                                message:
                                        error?.message || '관리자 연락처 저장 중 오류가 발생했습니다.',
                        });
                } finally {
                        setSaving(false);
                }
                                        ...
                                        <div className='flex flex-col gap-6'>
                                                <div className='flex flex-col gap-3'>
                                                        <div className='flex items-center justify-between'>
                                                                <p className='text-Gray-900 body-lg-medium'>이메일 목록</p>
                                                                <IconButton
                                                                        icon={<Plus />}
                                                ...
                                                <div className='flex flex-col gap-3'>
                                                        <div className='flex items-center justify-between'>
                                                                <p className='text-Gray-900 body-lg-medium'>전화번호 목록</p>
                                                                <IconButton
                                                                        icon={<Plus />}
