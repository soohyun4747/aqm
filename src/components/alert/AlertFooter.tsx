...
export function AlertFooter(props: ModalFooterProps) {
	return (
		<div style={{justifyContent: props.thirdBtnProps ? 'space-between' : 'center'}} className='md:w-[640px] w-[416px] p-5 pt-0 flex items-center border border-Gray-200 border-t-0 rounded-bl-[8px] rounded-br-[8px] bg-white'>
