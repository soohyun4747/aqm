...
export const buttonVariants: { [key: string]: string } = {
	primary:
		'text-white bg-Primary-700 hover:bg-Primary-800 disabled:bg-Primary-400',
	primaryOutline:
		'text-Primary-700 border border-Primary-700  hover:bg-Primary-800 hover:text-white disabled:borer-primary-400 disabled:text-Primary-400 disabled:bg-transparent',
	alternative:
		'text-black bg-white border border-Gray-200  hover:bg-transparent hover:text-Primary-700 disabled:text-Gray-400',
	danger: 'text-white bg-Orange-700 hover:bg-Orange-800 disabled:bg-Orange-400',
} as const;
